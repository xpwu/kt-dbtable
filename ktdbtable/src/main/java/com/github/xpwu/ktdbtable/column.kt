...
//// in
//infix fun BooleanColumn.`in`(values: BooleanArray): Where {
//  return In(this.name, values)
//}
//
//// between
//infix fun BooleanColumn.btw(rang: Pair<Boolean, Boolean>): Where {
//  return Between(this.name, rang.first, rang.second)
//}
...
//// between
//infix fun StringColumn.btw(rang: Pair<Byte, Byte>): Where {
//  return Between(this.name, rang.first, rang.second)
//}
